...
public enum Departamento {
    ...
    public static Departamento getDepartamentoByString(String departamento){
        ...
        if(departamento.equals("Ingenieria")) {return Departamento.INGENIERIA_ELECTRONICA_Y_COMUNICACIONES;}
        if(departamento.equals("Informatica")) {return Departamento.INFORMATICA_E_INGENIERIA_DE_SISTEMAS;}
        // Cualquier otro caso
        else {return null;}
    }
}
